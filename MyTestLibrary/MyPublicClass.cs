namespace MyTestLibrary
{
    public class MyPublicClass
    {
        ...
        {
            System.Console.WriteLine($"Printing from Instance. InstanceProperty: {InstanceProperty}");
        }

        // Public Static Method (no parameters, returns void)
        public static void PrintStaticMessage()
        {
            System.Console.WriteLine($"Printing from Static. StaticProperty: {StaticProperty}");
        }
    }
}